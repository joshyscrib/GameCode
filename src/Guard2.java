...
public class Guard2 extends Mob {
    ...
    public Guard2(int pX, int pY) {
        ...
        URL img1 = getClass().getClassLoader().getResource("images/guard2-1.png");
        URL img2 = getClass().getClassLoader().getResource("images/guard2-2.png");
        try {
